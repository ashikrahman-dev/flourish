...
export default function Slider() {
    return (
        <div>
            <div className="relative min-h-[850px] h-full w-full px-5">
                <div className="slide-bg-gradient absolute left-0 right-0 top-0 w-full h-full z-10"></div>
                <div className="">
                    <Image
                        alt="Slide 1"
                        src={slide_1_bg}
                            ...
                            <div className=" w-full">
                                <div className="max-w-[520px]">
                                    ...
                                    <p className="font-mulish text-base font-normal leading-[1.87em] mt-5">
                                        If you help people improve their lives -
                                        whether thats emotionally, socially,
                                        physically, or spiritually - Flourish is
                                        for you.
                                    </p>
                                    <Link
                                        href={"/"}
